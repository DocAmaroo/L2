...
string Couleur2String(Cellule::Couleur c) {
  ...
  switch (c) {
  case Cellule::NOIR:
    res = "\033[1;40m  \033[0m"; //"noire";
    break;
  case Cellule::BLEU:
    res = "\033[1;44m  \033[0m";//"bleue";
    break;
  case Cellule::VERT:
    res = "\033[1;42m  \033[0m";//"verte";
    break;
  case Cellule::ROUGE:
    res = "\033[1;41m  \033[0m";//"rouge";
    break;
  case Cellule::JAUNE:
    res = "\033[1;43m  \033[0m";//"jaune";
    break;
  default:
    res = "non définie.";
