...
\usepackage{fullpage} %use maximum of the page
\usepackage{ragged2e} %justify text
\usepackage{makeidx}  %index

%better looking tableofcontent
\usepackage{tocloft}
\cftsetindents{section}{0em}{2.5em}
\cftsetindents{subsection}{2em}{3.5em}

\renewcommand{\thesection}{\Roman{section}} %section have roman number
\renewcommand{\thesubsection}{\thesection.\alph{subsection}} %subsection have alphabetic letter
...
\section{Qu'est ce qu'un logiciel ?} \index{logiciel}
...
\section{La FSF et le projet GNU} \index{GNU}
...
\section{GNU/Linux, une réalité} \index{GNU}
